...
server.workspace('DQMContent', 22, 'Tracker', 'PixelPhase1Heterogeneous', '^PixelPhase1Heterogeneous/', '',
                 'PixelPhase1Heterogeneous/Layouts/00 - PixelPhase1 RecHit Position: GPU vs CPU',                 
)
